...
cmd = 'time ./waf --run "fat-tree --LinkBandwidth=10Mbps  --Delay=0.2 --QueueSize=100 --Protocol=TCP --K=4 --Monitor=false --Debug=true --Animation=false --SimulationTime=60 --SizeDistribution=distributions/enterprise_conga_scaled_100.csv  --IntraPodProb=0 --InterPodProb=1 --InterArrivalFlowTime=1600 --ErrorRate={0} --ErrorLink=r_0_a0->r_c0 --EcmpMode={1} --ExperimentName={1}_{0} --RunStep=1" &'
